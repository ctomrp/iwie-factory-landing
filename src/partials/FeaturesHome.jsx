              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">
                    Beneficios de nuestros servicios con drones
                  </div>
                  <p className="text-xl text-gray-400 mb-4">
                    La aplicación de tecnología de drones en la agricultura
                    ofrece una serie de ventajas notables
                  </p>
                  <ul className="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                    ...
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Salud de los cultivos</span>
                    </li>
                    <li className="flex items-center mx-2 my-1">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                  ...
                  <div className="flex items-start mt-8">
                    ...
                    <div>
                      <blockquote className="text-gray-400 italic m-0 mb-3">
                        La satisfacción de nuestros clientes es nuestro mejor
                        respaldo.
                      </blockquote>
